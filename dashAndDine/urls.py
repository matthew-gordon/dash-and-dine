...
from dashanddineapp import views, apis
...
urlpatterns = [
    ...
    url(r'^api/customer/customer/driver/location/$', apis.customer_driver_location),
    ...
    url(r'^api/driver/location/udate/$', apis.driver_update_location),
